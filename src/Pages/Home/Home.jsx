    ...
    <div>
      ...
      <div>
        <div
          ...
          id="top"
          style={{ backgroundImage: "url(" + hero + ")",backgroundRepeat:"no-repeat",backgroundSize:"contain" }}
        >
          <div className="heroSearch">
            <div className="herobtn">
              <button className="herobtnFirst">
                <LocationOnOutlinedIcon
                  style={{ color: "#008081", fontSize: "medium" }}
                />
          ...
          <div className="cardContainer">
            <div className="card">
              ...
              <p className="cardLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} /> Isolo,
                Lagos State
              </p>
              ...
              <div className="buttonContainer">
                ...
                <button>
                  <a href="www.google.com">Connect</a>
                </button>
              </div>
            </div>
            <div className="card">
              ...
              <p className="cardPolicy">Pay per job</p>
              <p className="cardLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} /> Ikeja,
                Lagos State
              </p>
              <span className="review">
                <StarIcon fontSize="small" />
            ...
            <div className="card">
              ...
              <p className="cardPolicy">Pay per job</p>
              <p className="cardLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} /> V.I,
                Lagos State
              </p>
              <span className="review">
                <StarIcon fontSize="small" />
            ...
            <div className="card">
              ...
              <p className="cardPolicy">Pay per job</p>
              <p className="cardLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} /> Ikorodu,
                Lagos State
              </p>
              <span className="review">
                <StarIcon fontSize="small" />
            ...
            <div className="card">
              ...
              <p className="cardPolicy">Pay per job</p>
              <p className="cardLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} /> Ojota,
                Lagos State
              </p>
              <span className="review">
                <StarIcon fontSize="small" />
            ...
            <div className="lastitem">
              <button className="lastbtn">
                <a href="www.google.com">View all Jobs</a>
              </button>
            </div>
          </div>
        </section>
        ...
        <div className="candidateSection">
          <div className="candidateCard">
            ...
            <div>
              ...
              <p className="candidateLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} /> Ketu,
                Lagos State
              </p>
              <span className="candidateReview">
                <StarIcon fontSize="small" />
                0.0
              </span>
          ...
          <div className="candidateCard">
            ...
            <div>
              ...
              <p className="candidateLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} />{" "}
          ...
          <div className="candidateCard">
            ...
            <div>
              ...
              <p className="candidateLocation">
                <LocationOnOutlinedIcon style={{ color: "#008081" }} /> Ikoyi,
                Lagos State
              </p>
              <span className="candidateReview">
                <StarIcon fontSize="small" />
      ...
      <div className="about" id="about">
        ...
        <p>
          The HandyManny Website is a subscription based online listing platform
          for professional and experienced artisans in Nigeria. For freelance
          artisans, the platform gives them room to subscribe and earn money
          while being mobile, list their Services, collaborate with other
          artisans and build their client base For workshop owners, the platform
          offers subscription for an easy way to list their business, sell
          products connect with other professionals, expand their customer base
          including business travelers and tourists, while improving their
          expertise. The platform also has an integrated payment full-service
          Solution for easy transaction tracking and sales record.
        </p>
        <div className="center">
          <button>
            <a href="www.google.com">View More About Us</a>
          </button>
        </div>
      </div>
      {/* about us ends */}
      ...
      <div className="licenseContainer">
        ...
        <p>
          ...
          artisans, the platform gives them room to subscribe and earn money
          while being mobile, list their Services, collaborate with other
          artisans and build their client base For workshop owners.
        </p>
      </div>
      {/* lisence ends */}
        ...
        <div className="contain">
          <div className="col">
            ...
            <ul>
              ...
              <li>
                <a href="www.google.com" alt="careers">
                  Careers
                </a>
              </li>
              <li>
                <a href="www.google.com" alt="terms of service">
                  Terms of Service
                </a>
              </li>
              <li>
                <a href="www.google.com" alt="privacy policy">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="www.google.com" alt="FAQ">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div className="col">
            ...
            <ul>
              <li>
                <a href="#categories" alt="automotive service">
                  Automotive Service
                </a>
              </li>
              <li>
                <a href="#categories" alt="electrician service">
                  Electrician Service
                </a>
              </li>
              <li>
                <a href="#categories" alt="building service">
                  Building Service
                </a>
              </li>
              <li>
                <a href="#categories" alt="privacy policy">
                  Computer/IT Service
                </a>
              </li>
              <li>
                <a href="#categories" alt="cleaning service">
                  Cleaning Service
                </a>
              </li>
              <li>
                <a href="#categories" alt="generator repair">
                  Generator Repair
                </a>
              </li>
            </ul>
          ...
          <div className="col">
            ...
            <ul>
              <li>
                <a href="www.linkedin.com" alt="linkedin">
                  Linkedin
                </a>
              </li>
              <li>
          ...
          <div className="endSection">
            ...
            <div className="endText">
              Copyright&copy; 2023 Handymanny. All rights reserved{" "}
              <a href="#top" alt="Back to top" className="topSection">
